angular.module('app-factory').directive('afServiceInputConfiguration', ['$compile', '$meteor', ($compile, $meteor) ->
	restrict: 'E'
	templateUrl: 'client/components/services/input/service-input-configuration.template.html'
	scope:
		'service': 	'='
	link: ($scope, $element) ->
