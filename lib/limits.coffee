@Limits =
	canCreateApplication: (user) ->
		return true unless Meteor.settings?.public?.public?.public.application_limits.should_enforce

		max_applications = Meteor.settings?.public?.public?.public.application_limits.max_applications
